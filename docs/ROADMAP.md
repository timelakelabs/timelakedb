...
| ~~P1-2 Audit trail~~ **DONE (SR-6, 2026-08-16)** — admin mutations hash-chained + fail-closed; `GET /admin/audit?verify=1`; sessions chained with a session id (#163, 2026-09-12); data-plane deferred | Enterprise-gated everywhere else; needs P0-3's principal | M |
