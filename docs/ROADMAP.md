...
| ~~P1-3 per-client rate limits~~ **DONE (SEC-6)** · ~~P1-4 error redaction~~ **DONE (SEC-5)** · ~~P1-5 WAL encryption~~ **DONE (SEC-8)** — all 2026-08-15. Still open: P1-6 Tributary mTLS (L4) · P1-7 queue RPO documented | as in PRODUCTION_READINESS | S–M |
